...
RESOURCES += src/qt/1up.qrc src/qt/1up_locale.qrc

TRANSLATIONS += src/qt/locale/1up_bg.ts \
                src/qt/locale/1up_de.ts \
                src/qt/locale/1up_en.ts \
                src/qt/locale/1up_es.ts \
                src/qt/locale/1up_fi.ts \
                src/qt/locale/1up_fr.ts \
                src/qt/locale/1up_it.ts \
                src/qt/locale/1up_ja.ts \
                src/qt/locale/1up_pl.ts \
                src/qt/locale/1up_pt.ts \
                src/qt/locale/1up_ru.ts \
                src/qt/locale/1up_sk.ts \
                src/qt/locale/1up_sv.ts \
                src/qt/locale/1up_vi.ts \
                src/qt/locale/1up_zh_CN.ts \
                src/qt/locale/1up_zh_TW.ts
