1UP Core version 2.3.0 is now available from:

  <https://github.com/1up-project/1up/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/1up-project/1up/issues>

Compatibility
==============

1UP Core is extensively tested on multiple operating systems using
...
1UP Core should also work on most other Unix-like systems but is not
...
[
  {
    ...
    winner: {
        address: addr,    (string) 1UP MN Address,
...
[
  {
    ...
    "addr": addr,      (string) Masternode 1UP address
...
1UP Core now enables bloom filters by default to support SPV clients like mobile wallets. This feature can be disabled by using the `-peerbloomfilters` option on startup.
...
- #195 `aee05fe` [ZMQ] ZMQ integration for 1UP (Mrs-X)
...
### Tests and QA
- #191 `3a778c3` [Tests] Fix the unit test suite for use with 1UP (Fuzzbawls)
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/1up-project-translations/).
