...
In order to support loading of multiple wallets in 1up-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is 1up.cpp.
...
Changes to 1up.cpp
----------------------
1up.cpp is the entry point into 1up-qt, and as such, will require some minor modifications to provide hooks for
