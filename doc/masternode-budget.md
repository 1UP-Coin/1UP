...
1UP now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<1up_address\> \<monthly_payment_1up\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ 1UP, _12_ times over the course of a year totaling _24000_ 1UP.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<1up_address\> \<monthly_payment_1up\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` 1UP.
