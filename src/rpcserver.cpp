...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* 1up features */
        {"1up", "masternode", &masternode, true, true, false},
        {"1up", "listmasternodes", &listmasternodes, true, true, false},
        {"1up", "getmasternodecount", &getmasternodecount, true, true, false},
        {"1up", "masternodeconnect", &masternodeconnect, true, true, false},
        {"1up", "masternodecurrent", &masternodecurrent, true, true, false},
        {"1up", "masternodedebug", &masternodedebug, true, true, false},
        {"1up", "startmasternode", &startmasternode, true, true, false},
        {"1up", "createmasternodekey", &createmasternodekey, true, true, false},
        {"1up", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"1up", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"1up", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"1up", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"1up", "getmasternodescores", &getmasternodescores, true, true, false},
        {"1up", "mnbudget", &mnbudget, true, true, false},
        {"1up", "preparebudget", &preparebudget, true, true, false},
        {"1up", "submitbudget", &submitbudget, true, true, false},
        {"1up", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"1up", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"1up", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"1up", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"1up", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"1up", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"1up", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"1up", "checkbudgets", &checkbudgets, true, true, false},
        {"1up", "mnsync", &mnsync, true, true, false},
        {"1up", "spork", &spork, true, true, false},
        {"1up", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"1up", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use 1upd, or the -server option to 1up-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> 1up-cli " + methodname + " " + args + "\n";
}
