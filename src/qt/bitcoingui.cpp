                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("1UP Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a 1UP address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and 1up: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About 1UP Core"), this);
    aboutAction->setStatusTip(tr("Show information about 1UP Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for 1UP"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your 1UP addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified 1UP addresses"));
    ...
    openAction->setStatusTip(tr("Open a 1UP: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the 1UP Core help message to get a list with possible 1UP command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("1UP Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to 1UP network", "", count));
}
...
{
    QString strTitle = tr("1UP Core"); // default title
