Contributing to 1UP Core
============================

The 1UP Core project operates an open contributor model where anyone is
...
The following applies to code changes to the 1UP Core project, and is not to be
confused with overall 1UP Network Protocol consensus changes.

Whether a pull request is merged into 1UP Core rests with the project merge
...
Patches that change 1UP consensus rules are considerably more involved than
...
Where a patch set proposes to change the 1UP consensus, it must have been
...
The project leader is the release manager for each 1UP Core release.
